...
func TestReconcile(t *testing.T) {
	...
	instance := &cnatv1alpha1.At{ObjectMeta: metav1.ObjectMeta{Name: "foo", Namespace: "default"}}
	...
	// Create the At object and expect the Reconcile and Deployment to be created
